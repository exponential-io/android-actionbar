...
The following diagram shows the connection between an Activity's layout file, class, file, menu
file, plus the themes.xml, colors.xml and dimens.xml.

<img src="./docs/android_app_bar.png">
